        ...
        <tbody>
          {data.slice(1).map((row, index) => (
            ...
            <RowComponent
              key={index}
              index={index}
              link={row[1]}  // Assuming 'links' is in the second column
              prefix={row[2]}  // Assuming 'prefix' is in the third column
              addTags={row[3]}  // Assuming 'select tags' is in the fourth column
