  ...
  return (
    <main className="flex">
      ...
      {!isMobile && (
        <div
          id="sideBoard"
          className="bg-blue-600 w-full h-screen -skew-x-6 ml-[-2.5rem] lg:-ml-32"
        >
      ...
      >
        {isMobile && (
          <div className="fixed top-0 left-0 w-full bg-blue-600 p-4 flex items-center">
        ...
        >
          ...
          {/* Icons at the end of the form */}
          <div className="flex justify-center mt-4">
            <span className="mx-2">
              <Image src={groupIcon} width={150} />
            </span>
          </div>
        </div>
      </div>
